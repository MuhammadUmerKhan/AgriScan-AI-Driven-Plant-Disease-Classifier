...
with tab2:
    ...
    with col2:
        if uploaded_file is not None:
            ...
            st.markdown(f'<br/><br/><br/><br/><br/><br/><br/><br/><div style="color: silver; font-size: 2em; font-weight: bold; text-align: center;">Prediction: {predicted_class} 🍃</div>', unsafe_allow_html=True)
